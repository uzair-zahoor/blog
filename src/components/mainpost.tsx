...
const Mainpost = () => {
  return (
    <>
      <div
        className="w-[650px] h-[450px] bg-red-200 ml-10 my-2 rounded bg-center bg-no-repeat bg-cover  relative drop-shadow-2xl cursor-pointer"
        style={{
          backgroundImage:
            "url('https://ventsmagazine.com/wp-content/uploads/2020/11/blog.jpg')",
        }}
      >
        <div className="absolute bottom-0 pb-6 text-center text-white  backdrop-grayscale-0 bg-black/30">
          {" "}
